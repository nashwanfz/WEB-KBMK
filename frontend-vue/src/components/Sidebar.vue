...
const fetchUserData = async () => {
  try {
    ...
    const response = await axios.get('https://kbmk.unmul.ac.id/api/api/me', {
      headers: {
    ...
    console.log('User Role:', userRole.value) // Debug
    console.log('User Name:', userName.value) // Debug
    console.log('User Division ID:', userDivisionId.value) // Debug
